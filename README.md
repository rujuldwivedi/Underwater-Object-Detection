...
The project compares the performance of the three models based on accuracy, inference time, and computational requirements.
Below are the output images generated by the project:
